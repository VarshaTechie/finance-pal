...
const IncomeForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Income Saved!',
        description: `Your income of ₹${numAmount.toLocaleString('en-IN')} for ${month} ${year} has been saved.`,
      });
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">
                ₹{parseFloat(amount).toLocaleString('en-IN')} for {month} {year}
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Enter your net monthly income after tax deductions
                </p>
              </div>
        ...
        <Card className="dashboard-card mt-6">
          <CardContent className="pt-6">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• Include all sources: salary, freelance, investments, etc.</li>
              <li>• Update monthly to keep your budget accurate</li>
              <li>• Consider adding bonuses separately when received</li>
            </ul>
          </CardContent>
        </Card>
      </div>
